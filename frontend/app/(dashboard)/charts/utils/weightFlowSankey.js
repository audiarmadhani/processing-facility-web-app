export const WEIGHT_FLOW_STAGES = [
...
export function reorderStagesMonotonically(stages) {
...
export function buildLinksForRow(row, grades = []) {
...
export function aggregateLinks(allLinks) {
  const map = new Map();
...
export function buildWeightFlowSankey(pipelineRows, gradeRows = [], filters = {}) {
