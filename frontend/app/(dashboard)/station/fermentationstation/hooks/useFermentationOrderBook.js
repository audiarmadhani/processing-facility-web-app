...
export function useFermentationOrderBook(station) {
  return useMemo(
    () => ({
      ...
      openAssignBatchDialog: station.openAssignBatchDialog,
      assignBatchRow: station.assignBatchRow,
      assignBatchNumber: station.assignBatchNumber,
      setAssignBatchNumber: station.setAssignBatchNumber,
      handleCloseAssignBatchDialog: station.handleCloseAssignBatchDialog,
      handleConfirmAssignBatch: station.handleConfirmAssignBatch,
      availableBatches: station.availableBatches,
