...
export function usePreprocessingStation(session) {
  ...
  const processingTypeOptions = {
    ...
    "Pulped Natural": ["Specialty", "G1", "G2", "G3", "G4"],
    "CM Natural": ["Specialty", "G1", "G2", "G3", "G4"],
    "CM Washed": ["Specialty", "G1", "G2", "G3", "G4"],
    "CM Pulped Natural": ["Specialty", "G1", "G2", "G3", "G4"],
    "Anaerobic Natural": ["Specialty", "G1", "G2", "G3", "G4"],
    "Anaerobic Washed": ["Specialty", "G1", "G2", "G3", "G4"],
    "Anaerobic Pulped Natural": ["Specialty", "G1", "G2", "G3", "G4"],
    "Aerobic Natural": ["Specialty", "G1", "G2", "G3", "G4"],
    "Aerobic Washed": ["Specialty", "G1", "G2", "G3", "G4"],
    "Aerobic Pulped Natural": ["Specialty", "G1", "G2", "G3", "G4"],
    "O2 Natural": ["Specialty", "G1", "G2", "G3", "G4"],
    "O2 Washed": ["Specialty", "G1", "G2", "G3", "G4"],
    "O2 Pulped Natural": ["Specialty", "G1", "G2", "G3", "G4"],
    "N2 Natural": ["Specialty", "G1", "G2", "G3", "G4"],
    "N2 Washed": ["Specialty", "G1", "G2", "G3", "G4"],
    "N2 Pulped Natural": ["Specialty", "G1", "G2", "G3", "G4"],
  };
